/**
 * Renders the AddProduct component, which is a form for adding a new product to the system.
 * The form includes fields for the product name, category, brand, size, price, and image.
 * The form also includes a description field for the product.
 * When the form is submitted, the product is added to the system.
 */
const AddProduct = () => {
  return (
    <div>
      <section className="p-3">
        <div className="flex items-center justify-between">
          <h2 className="mb-2 text-xl font-medium  ">Thêm sản phẩm</h2>
